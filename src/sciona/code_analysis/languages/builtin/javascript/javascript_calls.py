...
"""JavaScript call resolution utilities."""
...
def resolve_javascript_calls(
    ...
    *,
    ...
    adapter = _JavaScriptCallAdapter(
...
class _JavaScriptCallAdapter(CallResolutionAdapter):
    ...
    def resolve(self, request: CallResolutionRequest) -> List[CallResolutionOutcome]:
        ...
        raw_callee_text = request.callee_text
